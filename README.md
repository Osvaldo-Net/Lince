...
[![Version](https://img.shields.io/badge/version-4.0.3-6366f1?style=flat-square&labelColor=0f172a)](#)
...
services:
  Lince:
    ...
    # image: netosvaltools/lince:v4.0.2
    environment:
...
<img width="767" height="220" alt="image" src="https://github.com/user-attachments/assets/a9ffa0d3-e5d7-4832-87f8-015707dc3fda" />
